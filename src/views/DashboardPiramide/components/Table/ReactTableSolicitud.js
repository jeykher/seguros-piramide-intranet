...
const ButtonColorSolicitud = styled(Button)`
...
function Table({ columns, data }) {
  ...
  let numberOfRowsData = [5, 10, 20, 25, 30];
            ...
            {headerGroups.map((headerGroup) => (
              <tr {...headerGroup.getHeaderGroupProps()} className="rt-tr">
                {headerGroup.headers.map((column, key) => (
                  ...
                  >
                    <div className={column.id != "actions" ? "rt-resizable-header-content" : "rt-resizable-header-content-action"}>
         ...
         <div className="pagination-top">
          <div className="-pagination">
            <div className="-previous">
              {/* <ButtonColorSolicitud
                variant="Previous"
                onClick={() => previousPage()}
                disabled={!canPreviousPage}
                // style={{background:"#fc930a",color:"white",borderRadius:20}}
                className="-btn"
                id={id}
              >
                Anterior

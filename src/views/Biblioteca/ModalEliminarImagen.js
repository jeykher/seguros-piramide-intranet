...
const style = {
  ...
  export  function ModalEliminarDirectorioImagen({open,setOpen,tipoDirectorio,codigoDirectorio, codigoDirectorioPadre}) {
        ...
        >
          <Box sx={style}>
            ...
            <Button variant="contained" style={{marginTop:10}}
                onClick={() =>{ eliminarDirectorio("IMG", codigoDirectorio, codigoDirectorioPadre);

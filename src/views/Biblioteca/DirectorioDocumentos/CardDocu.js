...
import { ModalEliminarDirectorio } from './ModalEliminarDirectorioDoc';
...
const [tipoDirectorio, setTipoDirectorio] = useState("")
  ...
  return (
    <>
    {/*  <ModalEliminarDirectorio open={openModalConfirmacion}  setOpen={setOpenModalConfirmacion} tipoDirectorio={tipoDirectorio} codigoDirectorioPadre={codigoDirectorioPadre} /> */}
      ...
      <Card className={classes.root} elevation={20}>
        ...
        <AppBar position="static" className={classes.appBar}  >
            <Toolbar className={classes.toolbar}>
              ...
              <p  className={classes.tituloToolbar}> Directorio de Documentos </p>
            </Toolbar>
          </AppBar>
          <Grid container>
            {dataDirectorio.map((item, i) => (
              codPerfil === "adminDES" ||
                codPerfil === item.CODIGO_PERFIL?
                  ...
                  : null  */}
                  <Link to={`/Documentos?carpeta=${item.COD_DIRECTORIO}&nomDirectorio=${item.DESCRIPCION}`}>
